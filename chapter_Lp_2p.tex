...
\chapter{Analysis \rom{2}: $\Lp$ scattering identification in case \rom{2}} 
\label{chap-Lp_2p}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=12cm]{2p_pp_woPi.png}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=12cm]{2p_pp_wPi.png}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=12cm]{2p_Ldecay.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=12cm]{thetapp_dp.eps}
...
\begin{figure}[!h]
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[clip,width=\columnwidth]{dp_pp.eps}
  ...
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[clip, width=\columnwidth]{thetapp.eps}
...
\begin{figure}[!h]
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{zvertLp_sim.eps}
  ...
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{zvertLp.eps}
...
\begin{figure}[!h]
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{cdistLp_sim.eps}
  ...
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{cdistLp.eps}
