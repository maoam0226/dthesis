...
\begin{figure}[h!]
  \begin{center}
  \includegraphics[clip,width=12cm]{quarks.eps}
...
The quark model, in which baryons are composed of three quarks, was proposed by M. Gell-Mann \cite{mgm-1956} \cite{mgm-1961}. %Gluons are colored and anticolored simultaneously, and according to group theory, $3\times\overline{3}$ color combinations produce two kinds of multiplets: singlet and octet. 
...
\begin{figure}[h!]
  \begin{center}
  \includegraphics[clip,width=15cm]{colors.eps}
...
In the following, we discuss \say{baryon}, a composite subatomic particle consisting of three quarks. The wavefunction of the whole baryon can be written as
\begin{equation}
...
\begin{figure}[h]
  \begin{center}
  \includegraphics[clip,width=12cm]{B8.eps}
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[clip,width=15cm]{class.eps}
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[clip,width=12cm]{chiEFT_3S1_LN.eps}
...
Since the statistics of $YN$ scattering data are insufficient, LECs at NLO and higher order and the $\LNtoSN$ transition potentials still have ambiguity. Therefore, measuring the cross-sections of $YN$ scatterings in a higher energy range is required to constrain the $P$-wave contribution. %Hence, the experimental values of differential cross section and polarization observables in the $\Lambda$ beam momentum range of $400-800$ MeV/$c$ would play an important role in studying $\chi$EFT at NLO and higher order. 
...
%簡潔なE40の紹介
For the $\SN$ channels, recently we pioneered a new $\SPMp$ scattering experiment with high statistics. Here, we generate hyperons by irradiating the target with the J-PARC secondary meson beam to use as a tertiary beam to cause $YN$ scattering. %The generated hyperons are tagged by the missing mass method, and scattering events are indirectly identified by kinematical consistency analysis. 
...
\begin{figure}[!h]
  \begin{center}
   \includegraphics[width=15cm]{dcs_SMp.eps}
...
\begin{figure}[!h]
  \begin{center}
   \includegraphics[width=15cm]{dcs_SMpLn.eps}
...
\begin{figure}[!h]
  \begin{center}
   \includegraphics[width=15cm]{dcs_SPp.eps}
...
\begin{figure}[!h]
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{phaseshift_SPp_3S1.eps}
  \end{minipage}
  \hspace{0.04\columnwidth} % ここで隙間作成
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{phaseshift_SPp_1P1.eps}
  \end{minipage}
...
\begin{figure}[h!]
 \begin{center}
   \includegraphics[clip,width=8cm]{totcsLp_old.eps}
...
\begin{figure}[h!]
 \begin{center}
   \includegraphics[clip,width=12cm]{Lp_totcs_CLAS.eps}
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[clip,width=15cm]{Lp_dcs_models.eps}
...
\begin{figure}[h]
  \begin{center}
   \includegraphics[clip,width=12cm]{hypapp.eps}
...
\begin{figure}[h]
  \begin{center}
   \includegraphics[clip,width=12cm]{NS.eps}
...
\begin{figure}[h]
  \begin{center}
   \includegraphics[clip,width=12cm]{TBF.eps}
...
\begin{figure}[h!]
 \begin{center}
   \includegraphics[width=15cm]{theopred.eps}
...
\begin{figure}[h!]
 \begin{center}
   \includegraphics[width=12cm]{planes.eps}
...
%簡単な実験セットアップの特徴説明
%At the K1.1 beamline of the J-PARC hadron experimental facility, we will use the intensity of 30 M/spill (5.2 seconds cycle with a beam duration of 2 seconds) $\pM$ beam with the momentum of 1.05 GeV/$c$ and liquid hydrogen (LH$_2$) target with 30 cm long. The incident $\Lambda$ produced by the $\PiKL$ reaction will be tagged by the missing mass of the $\PiKX$ reaction. The total cross-section of the $\PiKL$ reaction was expected to be large ($\sim900\ \mu$b) at this momentum range \cite{Baker}. 

The $\Lambda$ beam is produced via the $\PiKL$ reaction with a total cross-section $\sim900\ \mu$b \cite{Baker} using $\pM$ beam momentum of 1.05 GeV/$c$. According to Ref. \cite{Baker}, the $\Lambda$ produced in the $\pM$ beam momentum range of 0.931 - 1.334 GeV/$c$ is $\sim100\%$ polarized at the forward $\Kz$ scattering angle, as shown in Figure \ref{fig-PL_Baker}. However, this data had the problem of low statistics and remained uncertain. Therefore, in this paper, we confirmed that the beam $\Lambda$ is automatically polarized and verified whether it can be used for the spin observable measurement in the J-PARC E86 experiment, using the $\PiKL$ reaction data obtained in the J-PARC E40 experiment.
...
\begin{figure}[!h]
  \begin{center}
   \includegraphics[width=15cm]{PL_Baker.eps}
